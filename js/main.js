let app = new Vue({
	...
	methods: {
		...
		endGame() {
			...
			if (this.score.zerg > this.score.protoss && this.score.zerg > this.score.terran && this.score.zerg > this.score.primal < 8 && Math.abs(this.score.protoss - this.score.zerg) > 3) {
